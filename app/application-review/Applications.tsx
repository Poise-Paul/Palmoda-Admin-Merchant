    ...
    const factors = [
      {
        ...
        value:
          new Date().getFullYear() - new Date(vendor.created_at).getFullYear() >
          5,
      },
      {
        label: "Verified business address",
        value: !!vendor.kyc_compliance?.address_line_one,
      },
      {
        label: "Tax ID confirmed",
        value: !!vendor.kyc_compliance?.tax_identification_number,
      },
      {
        label: "Missing identity verification",
        value: !vendor.is_identity_verified,
      },
      {
        label: "International business",
        value: vendor.kyc_compliance?.country !== "Nigeria",
      }, // Adjust as needed
    ];
        ...
        <div className="flex gap-4 px-4 py-2">
          <div className="border border-gray-200 py-3 px-4 w-[300px] flex flex-col gap-3.5">
            ...
            <div className="flex flex-col gap-px">
              ...
              <h2 className="text-black text-sm">
                {vendor?.kyc_compliance?.created_at
                  ? new Date(vendor.kyc_compliance.created_at).getFullYear()
                  : "N/A"}
              </h2>
            </div>
   ...
   "
        ...
        <div className="flex gap-4 my-3">
                    ...
                    <div key={index} className="border border-gray-200 p-2">
                      ...
                      <div className="ml-10">
                        <p className="text-xs text-gray-500">
                          {isMissing
                            ? "No file uploaded"
                            : doc.key.replace(/_/g, " ").toUpperCase()}
                        </p>
                        {!isMissing && (
                          <p className="text-xs text-gray-500">
                            Ready for review
              ...
              <div className="border border-gray-200 ">
                ...
                {messages.length > 0 ? (
                  messages.map((message, index) => (
                    <div
                      key={index}
                      className="border-b flex justify-between border-gray-200 p-2"
                    >
          ...
          <div className="flex flex-col gap-4 w-[350px] ">
            <div className="border border-gray-200 ">
              ...
              <div className="p-4">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <p
                    className={`text-xs font-semibold ${businessStatus.color}`}
                  >
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <p
                    className={`text-xs font-semibold ${identityStatus.color}`}
                  >
                ...
                <div className="mt-4">
                  ...
                  <p className="text-right text-xs text-gray-700 mt-1">
                    {overallProgress}% - {overallStatus.label}
                  </p>
                </div>
              </div>
            ...
            <div className="border border-gray-200 ">
              <h1
                className="text-black font-semibold text-sm mb-3 border-b px-4 py-3
                      border-gray-200"
              >
                Decision
              </h1>
