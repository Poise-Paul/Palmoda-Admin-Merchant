...
>
  ...
  <option value="Sole proprietor">Sole proprietor</option>
               ...
               {/* Country */} <label className="text-xs font-medium text-gray-600">Country</label>
                   ...
                   <select className="border border-gray-300 rounded-md px-3 py-2 text-sm
                    focus:ring-2 focus:ring-black/20">
                       <option>Any</option> <option>Yes</option>
                        <option>No</option> </select> {/* Onboarding Age */} 
                        ...
                        <select className="border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2
                         focus:ring-black/20"> <option>Any</option> <option>0–3 months</option>
                          <option>3–6 months</option> <option>6–12 months</option>
                           <option>1+ years</option> </select> {/* Last Activity */}
                            <label className="text-xs font-medium text-gray-600">Last Activity</label>
                             <select className="border border-gray-300 rounded-md px-3 py-2 text-sm
                              focus:ring-2 focus:ring-black/20"> <option>Any</option>
                               <option>Today</option> <option>This week</option> <option>This month</option> 
                               <option>1–3 months ago</option> <option>3+ months ago</option> </select> 
                               {/* Revenue Range */} <div className="flex flex-col gap-2"> <label className="text-xs font-medium text-gray-600">
                                Revenue Range</label> <div className="flex items-center gap-2"> 
                                  <input type="number" placeholder="Min"
                                   ...
                                   <span className="text-gray-500">-</span>
                                    ...
                                    className="border border-gray-300 rounded-md px-3 py-2 w-full
                                     text-sm focus:ring-2 focus:ring-black/20" /> </div>
                                      </div> {/* NEW CHECKBOX FILTERS */} 
                                      <div className="flex flex-col gap-2 mt-2"> 
                                        ...
                                        <label className="flex items-center gap-2 text-sm"> 
                                          ...
                                          Flagged Only </label>
                                           <label className="flex items-center gap-2 text-sm"> 
                                            <input type="checkbox" className="accent-black" /> With Disputes </label>
                                             <label className="flex items-center gap-2 text-sm"> 
                                              <input type="checkbox" className="accent-black" /> Inventory Low </label> 
                                              </div> {/* ACTION BUTTONS */}
              ...
              vendors.map((vendor) => (
                <tr key={vendor._id} className="border-b border-gray-100 hover:bg-gray-50 transition">
                  ...
                  <td className="py-3 px-4 flex items-center gap-2">
                    <Link href={`/application-review/${vendor?._id}`} className="px-3 py-1 border text-black bg-inherit text-xs">View</Link>
